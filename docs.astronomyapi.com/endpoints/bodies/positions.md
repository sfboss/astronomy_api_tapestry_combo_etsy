...
See [Body Properties](https://docs.astronomyapi.com/requests-and-response/body-properties) for the available properties of bodies.

## Get all bodies positions

<mark style="color:blue;">`GET`</mark> `https://api.astronomyapi.com/api/v2/bodies/positions`
...
<mark style="color:blue;">`GET`</mark> `https://api.astronomyapi.com/api/v2/bodies/positions/:body`
